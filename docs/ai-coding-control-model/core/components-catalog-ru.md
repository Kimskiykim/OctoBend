...
### 2.2. Упрощённый flow выполнения
...
### 2.4. Диаграмма основных областей задач AI-кодинга
...
### 3.1. Идея: отдельный срез взаимодействия и эффективности

Эта проработка пока не входит в слайдовую карту основных областей. Её лучше держать как отдельную идею: как человек и агент взаимодействуют, передают состояние и улучшают постановку задач.
...
### 3.2. Инсайт: модель должна зависеть от концепций, а не от фреймворка
...
### 3.3. Инсайт: Vibe Coding и SDD как управляемый спектр
...
### 3.4. Идея: разбирайте завершённые сессии
...
### 3.5. Инсайт: контекстное окно всегда будет меньше проекта
...
### 3.6. Инсайт: узкое место смещается в интеграцию и проверку
...
### 3.7. Инсайт: код тоже должен стать удобным для контекста
...
### 3.8. Инсайт: Markdown-артефактам нужен жизненный цикл
